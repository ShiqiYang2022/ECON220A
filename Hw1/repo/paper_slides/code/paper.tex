...
\]
Both $p_{jct}$ and $\log s_{j|g,ct}$ are endogenous after FE; cost shifters and nest-size shifters are used as instruments.
...
\input{Hw1/repo/analysis/output/q20_nested_ivfe}
...
\input{Hw1/repo/analysis/output/q21_nl_elasticities_city1p1}
\input{Hw1/repo/analysis/output/q21_nl_diversion_city1p1}
...
\input{Hw1/repo/analysis/output/q24_nl_welfare_city1p1}
